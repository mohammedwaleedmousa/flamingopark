      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm">
              <li>
                <Link to="/products?category=necklaces" className="hover:text-gold transition-colors">
                  القلائد
                </Link>
              </li>
              <li>
                <Link to="/products?category=rings" className="hover:text-gold transition-colors">
                  الخواتم
                </Link>
              </li>
              <li>
                <Link to="/products?category=bracelets" className="hover:text-gold transition-colors">
                  الأساور
                </Link>
              </li>
              <li>
                <Link to="/products?category=earrings" className="hover:text-gold transition-colors">
                  الأقراط
                </Link>
              </li>
            </ul>
