                ...
                <section className="mx-auto w-full rounded-[24px] bg-transparent px-0 py-1 sm:border sm:border-[#ECE7E4] sm:bg-white sm:p-6 sm:shadow-[0_16px_50px_rgba(68,50,45,0.04)] lg:p-7">
                  ...
                  {mode === "login" ? (
                    ...
                    <form onSubmit={handleCredentials} className="mt-3 space-y-2.5">
                      <div><label htmlFor="auth-phone" className={labelClass}>رقم الهاتف الدولي</label><div className="relative"><Phone className="pointer-events-none absolute right-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-[#A89D98]" /><input id="auth-phone" type="tel" autoComplete="tel" value={formData.phone} onChange={(event) => updateField("phone", event.target.value)} placeholder="+966 5X XXX XXXX" dir="ltr" className={`${fieldClass} pr-10 text-left`} /></div></div>
