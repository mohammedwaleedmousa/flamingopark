                      ...
                      <div className="flex flex-col md:flex-row">
                        {offer.image_url && (
                          <div className="md:w-1/3 aspect-video md:aspect-auto relative">
                            <img loading="lazy" decoding="async" width={1200} height={675} sizes="(max-width: 768px) 100vw, 33vw" src={offer.image_url} alt={offer.title_ar} className="w-full h-full object-cover" />
