...
// يحوّل اسم الماركة إلى slug صالح للرابط (يحافظ على الحروف العربية والإنجليزية والأرقام)
...
const AdminBrandsPage = () => {
  ...
  // بيتحول لـ false لو المستخدم عدّل الـ slug يدوياً، عشان مانلخبطش تعديله بالتوليد التلقائي
  ...
  const handleEdit = (brand: Brand) => {
    ...
    // لو الماركة القديمة معندهاش slug أصلاً، نخلي التوليد التلقائي شغال
  ...
  const handleNameChange = (name: string) => {
    setFormData((prev) => ({
      ...prev,
      name,
      slug: slugAutoGenerated ? generateSlug(name) : prev.slug,
    }));
  };
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    {!brand.slug && (
                      <p className="text-xs text-destructive mt-1">⚠ لا يوجد رابط (slug) لهذه الماركة</p>
                    )}
        ...
        {filteredBrands.map((brand,index)=>(
          <motion.div key={brand.id} initial={{opacity:0,y:15}} animate={{opacity:1,y:0}} transition={{delay:index*0.04}} className="group relative bg-card border border-border rounded-3xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
            ...
            <div className="text-center mt-6">
              ...
              {!brand.slug && (
                <p className="text-xs text-destructive mt-1">⚠ لا يوجد رابط (slug)</p>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ده اللي هيظهر في رابط صفحة الماركة: /brands/{formData.slug || '...'}
                  </p>
                </div>
