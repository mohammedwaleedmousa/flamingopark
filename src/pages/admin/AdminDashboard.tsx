    ...
    "
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 bg-white border rounded-2xl shadow-sm hover:shadow-md transition">
          ...
          <p className="text-xs mt-3 text-gray-500">+18% مقارنة بالأمس</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border p-5">
          ...
          <p className="text-xs mt-3 text-green-600">● Live</p>
        </div>
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {kpis.map((k) => (
          <div key={k.label} className="bg-white border rounded-2xl p-5 hover:shadow-md transition">
            {" "}
